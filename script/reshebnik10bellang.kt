...
class reshebnik10bellang : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_reshebnik10bellang)
        ...
        webView.loadUrl("https://resheba.top/belorusskij-jazyk-10-klass");

        fun shouldOverrideUrlLoading(view: WebView?, url: String?): Boolean {



            val adUrls = listOf("ads.example.com", "track.example.com")
