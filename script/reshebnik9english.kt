...
class reshebnik9english : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_reshebnik9english)
...
//
        webView.loadUrl("https://resheba.top/gdz/9-klass/anglijskij-jazyk")
