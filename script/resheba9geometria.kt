...
class resheba9geometria : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_resheba9geometria)
        ...
        webView.loadUrl("https://resheba.top/geometrija-9-klass-kazakov")
