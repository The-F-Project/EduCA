...
class reshebnik8th : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        russian.setOnClickListener {
            ...
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://resheba.top/russkij-jazyk-8-klass")); startActivity(browserIntent);
        ...
        geo.setOnClickListener {
            ...
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://superresheba.by/8-geography-book_176")); startActivity(browserIntent);
